...
assetApp.controller('AssetListCtrl', function ($scope, assetService) {
    ...
    $scope.UpLoad = function () {
        ...
        location.href = "http://ec2-54-84-77-221.compute-1.amazonaws.com/ingest_stage/Handler.ashx?source=Search" + "&vertical=" + $scope.section + "&status=" + $scope.status + "&list=" + ct;
